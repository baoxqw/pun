    ...
    <div class="app-container">
        ...
        <div class="head-container">
            <div>
                ...
                <el-input v-model="query.userName" clearable size="small" placeholder="申请人" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery"/>
        ...
        <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" @selection-change="crud.selectionChangeHandler">
            ...
            <el-table-column v-if="columns.visible('ORIGINAL_INST_ID')" prop="ORIGINAL_INST_ID" min-width="20%" label="申请编号" />
            <el-table-column v-if="columns.visible('NAME')" prop="NAME" min-width="20%" label="申请名称" />
            <el-table-column v-if="columns.visible('DEPT_NAME')" prop="DEPT_NAME" min-width="10%" label="申请部门" />
            <el-table-column v-if="columns.visible('NICK_NAME')" prop="NICK_NAME" min-width="10%" label="申请人"/>
            <el-table-column v-if="columns.visible('CRT_DATE')" prop="CRT_DATE" min-width="15%" label="申请时间"/>
            <el-table-column v-if="columns.visible('STATUS')" prop="STATUS" min-width="10%" label="状态" >
            ...
            <el-table-column label="操作" min-width="10%" fixed="right">
                <template slot-scope="scope">
                    <!--<el-button type="primary" icon="iconfont icon-icon-test" @click="showDetail(scope.row)">详情</el-button>-->
        ...
        <el-dialog :close-on-click-modal="false" @close="closeApproveDialog" :title="approveTitle" width="65%" :visible="formDialog">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-form ref="form" :model="form" size="small" label-width="100px">
                    ...
                    <el-col>
                        <el-tabs type="border-card" @tab-click="handleClick" active-name="atomList" id="atomTabs">
                            <el-tab-pane label="指标信息" name="atomList">
                                <el-table :data="tabData" size="small">
                                  ...
                                  <el-table-column label="操作" width="80px" fixed="right">
                                      <template slot-scope="scope">
                                        <el-button slot="left"  type="success" @click="showAtomDetail(scope.row)">
                                          详情
                                        </el-button>
                                      </template>
                                  </el-table-column>
                    ...
                    <el-col>
                      <el-row style="padding-top: 20px">
                        <el-col :xs="24" :sm="24" :md="24" :lg="12" :xl="24">
                            <el-form-item label="审批意见:" label-width="110px">
                                <el-input type="textarea" v-model="form.apprComment"  style="min-width: 500px;max-width: 800px" @input="onInput()"/>
                            </el-form-item>
                        </el-col>
                      </el-row>
                      <el-row>
                        <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" style="text-align: right;padding-right: 40px">
                            <el-form-item label-width="110px">
                                <template slot-scope="scope">
                                  <el-button  type="success" plain round @click="completeTask('1')">审批拒绝</el-button>
                                  <el-button  type="success" round  @click="completeTask('0')" >审批通过</el-button>
                                </template>
                            </el-form-item>
                        </el-col>
                      </el-row>
        ...
        methods : {
          ...
          // 获取数据前设置好接口地址
            ...
            showAtomDetail(data) {
              ...
              _thisAtom.form.indAggFunction = data.indAggFunction
              _thisAtom.form.indModelTable = data.indModelTable
              _thisAtom.form.indModelCols = data.indModelCols
              _thisAtom.initIndModelCols()
