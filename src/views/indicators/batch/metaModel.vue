<template>
  <div class="app-container">
    ...
    <div class="head-container">
      <!-- 搜索 -->
      <div>
        <el-input v-model="query.tabName" clearable size="small" placeholder="表名称" style="width: 200px;"
          class="filter-item" />
              ...
              <el-col :span="24">
                <el-form-item label="数据源" prop="tableRegionalBut">
                  <el-radio-group v-model="form.tableRegionalBut" size="small">
                    <el-radio v-for="dict in dbTypeOptions" :key="dict.label" :label="dict.label">
                      {{ dict.label }}</el-radio>
                  </el-radio-group>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="12">
                <el-form-item label="模型目录" prop="modelLvl">
                  <el-select class="block" v-model="form.modelLvl" filterable clearable size="small"
                    placeholder="模型目录">
                    <el-option v-for="dict in modelLvlOptions" :key="dict.dictValue" :label="dict.label"
                      :value="dict.dictValue"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
