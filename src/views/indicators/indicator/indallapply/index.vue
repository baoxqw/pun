...
<script>
import crudIndAllApplyInfo from '@/api/indAllApply/indAllApplyInfo'
...
// crud交由presenter持有
const defaultCrud = CRUD({ title: '指标使用情况', url: crudIndAllApplyInfo.url, sort: 'id,desc', crudMethod: { ...crudIndAllApplyInfo.crud }})
