  ...
  <div class="app-container">
    ...
    >
      <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="80px">
        ...
        <el-form-item v-show="form.type.toString() == '1'" label="数据权限" prop="dataAuthType">
          <el-select v-model="form.dataAuthType" :disabled="form.iframe" style="width: 178px;" default-first-option>
            <el-option
        ...
        <el-tooltip class="item" effect="dark" content="注意：请配置绝对路径(以&quot;/&quot;开始)" placement="top-end">
          <el-form-item v-if="form.type.toString() !== '2'" label="路由地址" prop="path">
            <el-input v-model="form.path" placeholder="路由地址(绝对路径)" style="width: 178px;" />
          </el-form-item>
        </el-tooltip>
