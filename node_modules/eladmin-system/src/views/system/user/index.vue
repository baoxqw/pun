      ...
      <el-col :xs="9" :sm="6" :md="4" :lg="4" :xl="4">
        <div class="category-container">
          ...
          <el-scrollbar class="el-tree treeScroll">
            <el-tree style="border:0px" :data="deptDatas" node-key="id" :default-expanded-keys="['1']" :props="defaultProps" :expand-on-click-node="false" accordion @node-click="handleNodeClick">
      ...
      <el-col :xs="15" :sm="18" :md="20" :lg="20" :xl="20">
        ...
        <div class="head-container">
          <div v-if="crud.props.searchToggle">
            <!-- 搜索 -->
            <el-input v-model="query.blurry" clearable size="small" placeholder="输入名称昵称或者邮箱搜索" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery"/>
            <el-date-picker  v-model="query.createTime" :default-time="['00:00:00','23:59:59']" type="daterange" range-separator=":" size="small"
              class="date-item" value-format="yyyy-MM-dd HH:mm:ss" start-placeholder="开始日期" end-placeholder="结束日期"/>
            <el-select v-model="query.enabled" clearable size="small" placeholder="状态" class="filter-item" style="width: 90px" @change="crud.toQuery">
              <el-option v-for="item in enabledTypeOptions" :key="item.key" :label="item.display_name" :value="item.key"/>
            </el-select>
            <el-select v-model="query.userType" clearable size="small" placeholder="用户类型" class="filter-item" style="width: 110px" @change="crud.toQuery">
<!--              <el-option v-for="item in userTypeOptions" :key="item.key" :label="item.user_type_select" :value="item.key"/>-->
          ...
          <crudOperation v-show="false" :permission="permission">
            <el-button slot="right" v-permission="permission.resetpwd" class="filter-item" type="success" icon="el-icon-setting" :loading="resetLoading"
        ...
        <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title">
          <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="100px">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-form-item label="编号" prop="username"><el-input v-model="form.username" :disabled="crud.status.flag == 2" style="width: 400px"/></el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-form-item label="姓名" prop="nickName"><el-input v-model="form.nickName" :disabled="crud.status.flag == 2" style="width: 400px"/></el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">

              <el-form-item label="机构" prop="deptName"><el-input v-model="form.dept.name" :disabled="crud.status.flag == 2" style="width: 400px"/></el-form-item>

              </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-form-item label="角色" prop="roles">
                  <el-select v-model="form.roles"  multiple placeholder="请选择" @remove-tag="deleteTag" @change="changeRole" value-key="roles" :disabled="crud.status.flag == 2" style="width: 400px">
...
<!--              <el-col :span="10">
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-form-item label="电话" prop="tel"><el-input v-model="form.tel" :disabled="crud.status.flag == 2" style="width: 400px"/></el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <el-form-item label="柜员编号" prop="tellerId"><el-input v-model="form.tellerId" :disabled="crud.status.flag == 2" style="width: 400px"/></el-form-item>
            </el-col>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
              ...
              <el-form-item label="状态">
                <el-radio-group v-model="form.enabled" :disabled="form.id === user.id || crud.status.flag == 2">
                  <el-radio v-for="item in enabledTypeOptions" :key="item.key" :label="item.key">{{ item.display_name }}</el-radio>
                </el-radio-group>
              </el-form-item>
            </el-col>
<!--              <el-col :span="10">
...
<!--            <el-row  type="flex"  justify="center">
        ...
        <el-table ref="table" v-loading="crud.loading" :data="crud.data" style="width: 100%;" @selection-change="crud.selectionChangeHandler">
          ...
          <el-table-column v-if="columns.visible('dept')" :show-overflow-tooltip="true" width="110" prop="dept" label="机构">
            <template slot-scope="scope"><div>{{ scope.row.dept?scope.row.dept.name:'未知部门'}}</div></template>
          </el-table-column>
          ...
          <el-table-column v-if="columns.visible('position')" :show-overflow-tooltip="true" width="125" prop="position" label="岗位"/>
...
<!--            <template slot-scope="scope">
            ...
            <template slot-scope="scope">
              <el-button class="filter-item" type="success" icon="el-icon-document" @click="crud.toDetail(scope.row)"/>
            </template>
          </el-table-column>
        </el-table>
        <!--分页组件-->
