      ...
      <el-table-column label="操作" width="100px" fixed="right">
        <template slot-scope="scope">
          ...
          >
            ...
            <el-button slot="reference" type="primary">强退</el-button>
          </el-popover>
        </template>
      </el-table-column>
    </el-table>
