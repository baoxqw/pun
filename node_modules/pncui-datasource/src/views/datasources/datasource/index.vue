  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <!-- 搜索 -->
        <el-input v-model="query.datasourceName" clearable size="small" placeholder="数据源名称" style="width: 20%;"
                  class="filter-item" @keyup.enter.native="crud.toQuery"/>
        <el-select v-model="query.datasourceType" clearable size="small" placeholder="数据库类型" class="filter-item"
                   style="width: 10%" @change="crud.toQuery">
...
<!--        <el-button
      ...
      <el-table ref="table" v-loading="crud.loading" :data="crud.data" size="small" style="width: 100%;"
        ...
        <el-table-column v-permission="['admin','indDatasource:edit','indDatasource:del']" label="操作" width="170px"
...
<!--            <udOperation
            ...
            />-->
            <el-button v-permission="permission.edit" :disabled="disabledEdit" type="primary"  @click="crud.toEdit(scope.row)" >修改</el-button>
            <el-button v-permission="permission.del" :disabled="disabledDle" type="danger"  @click="toDelete(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!--分页组件-->
